...
"Peso" .$peso."<br> Mi color favorito es"  .$ColorFav "<br> Soy de nacionalidad" .$Nacionalidad "<br>
Estado civil:"  .$EstadoCivil "<br>Fecha de nacimiento:" .$Nacimiento "<br>
Vivo en la colonia" .$Colonia;
?>